...
public class MainMenuScreen implements Screen {
    ...
    private void buildMenu() {
        ...
        Label subtitle = new Label("— MAIN MENU —", assets.editorSkin, "small");
        subtitle.setColor(assets.editorSkin.get("text-dim", Color.class));
        subtitle.setAlignment(Align.center);
        root.add(subtitle).colspan(2).padBottom(24).row();
